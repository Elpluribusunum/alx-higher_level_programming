...
I kept up my Python object-oriented programming practice in this project. Class methods, static methods, class vs. instance properties, and how to use the unique '__str__' and '__repr__' methods were all things I learned about.
